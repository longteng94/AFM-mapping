...
def get_drop_prop(file_path, fd_file_paths = None, level_order=1, fit_range=10000):
    ...
    elif jpk_data.file_format == 'jpk-force-map':# the file name can be changed as different AFM results
...
##    max_height = anal_data.get_max_height(zero_height)
    ...
    jpk_data.df[volume_mode].to_excel(f'{output_dir}/jumpin_distance_data.xlsx', index=None)
##    #analyze height data    
